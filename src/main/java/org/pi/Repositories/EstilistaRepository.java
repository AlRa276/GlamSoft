...
public class EstilistaRepository {
    ...
    // Lista de estilistas disponibles para un servicio en una fecha/hora específica
    public List<Estilista> findEstilistasServicios(int idServicio, Cita fechaCita) throws SQLException {
        ...
        // Se usa WEEKDAY: 0=Lunes, 1=Martes, ..., 6=Domingo
        String sql = "SELECT DISTINCT e.nombre, e.imagen_perfil " +
                "FROM empleado e " +
        ...
        try (
            ...
            // Timestamp completo para WEEKDAY
            stmt.setTimestamp(2, Timestamp.valueOf(fechaCita.getFechaCita()));
            // Timestamp completo para TIME() extraction
